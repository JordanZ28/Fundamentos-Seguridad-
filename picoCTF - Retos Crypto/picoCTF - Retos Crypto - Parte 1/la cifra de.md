...
# Solución 
```
se nos muestra este puerto para poder concectarnos 
`nc jupiter.challenges.picoctf.org 5726` 

ya adentro se nos da un mensaje  
...
utilizando este pagina https://www.guballa.de/vigenere-solver 

podemos utlizar el vignenere clasico para poder codificar la bandera y obtene la llave 
